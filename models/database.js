...
client.connect();
var query = client.query('CREATE TABLE events(id SERIAL PRIMARY KEY, event_da TEXT NOT NULL, event_en TEXT NOT NULL, url TEXT, created TIMESTAMP, img_id INT NOT NULL)');
