...
client.connect();
var query = client.query('CREATE TABLE events(id SERIAL PRIMARY KEY, event_da TEXT NOT NULL, event_en TEXT NOT NULL, url TEXT UNIQUE NOT NULL, created TIMESTAMP)');
